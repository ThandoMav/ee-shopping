...
export default function Layout({ children, title }) {
  ...
  return (
    <>
      <Head>
        <title>{title ? title : 'Ok.Lesedi'}</title>
        <meta name="student blog" content="student Website" />
        <meta name="monetag" content="7dfb0ee4ccebd9518e6723ad5b453b9b" />
        <meta name="09687ede797df4e3ed7eca4e8f37df3852d14ac8" content="09687ede797df4e3ed7eca4e8f37df3852d14ac8" />
        ...
        <div>
          ...
          >
            <div className="mb-2 flex justify-between">
              <h2 className="text-white">Ok.Lesedi</h2>
            ...
            <li onClick={() => setShowSidebar(false)}>
                <Link href={`/search-posts`}>News&Stories </Link>
            </li>
            <li onClick={() => setShowSidebar(false)}>
