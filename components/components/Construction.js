...
const About = () => {
  return (
    <>
    <section class="relative md:h-screen py-36 flex items-center bg-center overflow-hidden">
            ...
            <div class="container relative z-1 mx-auto">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div class="lg:col-span-8 md:col-span-7 md:order-1 order-2">
                        <div class="md:mr-6">
                            <h4 class="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">Start building <br /> your dream home</h4>
                    ...
                    <div class="lg:col-span-4 md:col-span-5 md:text-center md:order-2 order-1">
                        <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="lightbox lg:h-24 h-20 lg:w-24 w-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white hover:bg-indigo-600 text-indigo-600 hover:text-white duration-500 ease-in-out mx-auto">
                            ...
                            <div class="grid lg:grid-cols-12 grid-cols-1">
                                <div class="lg:col-span-4 order-1 lg:order-2 bg-indigo-600">
                                    <div class="p-[30px] lg:text-left text-center">
                                        ...
                                        <div class="mt-6">
                                            <a href="#" class="btn bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white rounded-md">About us</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container md:mt-24 mt-16 mx-auto">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div class="md:col-span-5">
                        <div class="relative">
                            ...
                            <div class="absolute bottom-16 right-0">
                                <img src={iimage} class="rounded-md rounded-br-[30px] shadow-md w-56 h-56" alt="" />
                                <div class="absolute bottom-0 right-0 text-center">
                                    <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="lightbox h-14 w-14 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-indigo-600 text-white">
                    ...
                    <div class="md:col-span-7">
                        <div class="lg:ml-4">
                            <span class="bg-indigo-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">About Company</span>
                            <h4 class="mb-6 mt-4 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">World's largest and <br /> trusted construction company</h4>
                            ...
                            <div class="mt-6">
                                <a href="#" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Read More <i class="uil uil-angle-right-b align-middle"></i></a>
                            </div>

                            <div class="pt-6 mt-6 border-t dark:border-gray-700">
                                <div class="relative grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                                    <div class="counter-box">
                                        <h1 class="text-4xl font-bold mb-2"><span class="counter-value" data-target="1548">1010</span>+</h1>
                                        <h5 class="counter-head text-lg font-medium">Projects completed</h5>
                                    </div>

                                    <div class="counter-box">
                                        <h1 class="text-4xl font-bold mb-2"><span class="counter-value" data-target="25">2</span>+</h1>
                                        <h5 class="counter-head text-lg font-medium">Years of experience</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container md:mt-24 mt-16 mx-auto">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src={iimage} class="rounded-md shadow dark:shadow-gray-800" alt="" /></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html" class="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg">Serenity Apartments</a></h5>
                    ...
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src={iimage} class="rounded-md shadow dark:shadow-gray-800" alt="" /></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html" class="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg">The Landscape House</a></h5>
                    ...
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src={iimage} class="rounded-md shadow dark:shadow-gray-800" alt=""/></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html" class="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg">New Build Family Home</a></h5>
                    ...
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src={iimage} class="rounded-md shadow dark:shadow-gray-800" alt="" /></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html" class="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg">Private and Social Apartments</a></h5>
                    ...
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src={iimage} class="rounded-md shadow dark:shadow-gray-800" alt="" /></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html" class="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg">Apartment Complex</a></h5>
                    ...
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src={iimage} class="rounded-md shadow dark:shadow-gray-800" alt="" /></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html" class="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg">Construction Engineering</a></h5>
        ...
        <section class="py-20 w-full table relative bg-center bg-no-repeat">
