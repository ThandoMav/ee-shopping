...
const Newsletter = ({ status, message, onValidated }) => {
  ...
  return (
    <section className='section section-sm lg:section-lg bg-green min-h-[520px]'>
      <div className='container mx-auto'>
        ...
        >
          ...
          >
            ...
            <button
              onClick={(event) => handleInputKeyEvent(event)}
              className='btn btn-lg btn-primary text-white w-full lg:max-w-[180px]'>
              Get started
            </button>
          </form>
        </div>
