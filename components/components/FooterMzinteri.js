...
// import data
import { footerMzinteri } from '../data';
// import components
import Copyright from '../components/CopyrightMzinteri';

const FooterMzinteri = () => {
  // destructure footer data
  const { logo, links, newsletter, form } = footerMzinteri;
  return (
