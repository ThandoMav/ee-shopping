...
// import components
import MzinteriSlider from './MzinteriSlider';

const TestimonialsMzinteri = () => {
  // destructure community data
  const { icon, title, testimonials } = community;
  return (
    <section className='section relative mb-64 lg:mb-10'>
      <div className='container mx-auto'>
        <div className='flex'>
          ...
          <div
            ...
            data-aos-delay='300'
          >
            <MzinteriSlider testimonials={testimonials} />
          </div>
        </div>
      </div>
      <br/>
...
export default TestimonialsMzinteri;
