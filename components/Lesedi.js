        ...
        <section className="section">
            <div className="container mx-auto">
                ...
                <div className="flex justify-center mt-8">
                    <a href="/abouttt" className="py-4 px-7 rounded text-sm font-medium bg-blue-500 text-white">More About Me <i className="mdi mdi-arrow-right ms-1"></i></a>
                </div>
            </div>
        </section>
                ...
                <div className="grid lg:grid-cols-3 gap-8 text-center">
                    <div>
                        <div className="p-5">
                            ...
                            <h4 className="uppercase text-base my-3">Advertising</h4>

                            <p className="text-muted">
Immerse your brand in a world of enchantment! I specialize in crafting authentic and visually stunning advertising campaigns that seamlessly blend into the fabric of my content. From beautifully curated posts to engaging stories, let's create a campaign that leaves a lasting impression.</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="p-5">
                            ...
                            <h4 className="uppercase text-base my-3">Event Hosting Extravaganza</h4>

                            <p className="text-muted">
Picture-perfect events don't just happen; they're curated with love and attention to detail. As an event host extraordinaire, I bring your vision to life. From product launches to intimate gatherings, each event is a masterpiece, leaving attendees with memories they'll cherish forever.
</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="p-5">
                            ...
                            <h4 className="uppercase text-base my-3">Bespoke Consultation</h4>

                            <p className="text-muted">
Embark on a one-on-one consultation journey with me. Together, we'll unravel the intricacies of your brand, discuss tailored strategies, and explore innovative ideas to elevate your online presence. This personalized session is designed to empower you with the knowledge and insights needed for a successful brand journey.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto">
                <div className="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
                    <div className="lg:col-span-8 md:col-span-6 md:text-left text-center">
                        ...
                        <p className="text-slate-400 max-w-xl">Start working with xxxxxx that can provide everything you need to generate awareness, drive traffic, connect.</p>
                    </div>
