...
const FeaturedAccCard = ({ accomodation }) => (
  <div className="relative h-72">
    ...
    <div className="flex flex-col rounded-lg p-4 items-center justify-center absolute w-full h-full">
     <BsBuildings />
      <p className="text-white mb-4 text-shadow font-semibold text-xs"> {accomodation.university}</p>
      <p className="text-white mb-4 text-shadow font-semibold text-2xl text-center">{accomodation.name}</p>
