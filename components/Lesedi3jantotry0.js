                ...
                <div className="sm:flex mt-4" id="grid">
                    <div className="lg:w-1/3 sm:w-1/2 picture-item p-4 rounded-md">
                        <div className="">
                            ...
                            <div className="pt-4 px-3">
                                <h5 className="mb-1 font-semibold text-lg"><a href="https://1.envato.market/techwind" target="_blank" rel="noreferrer" className="hover:text-indigo-600 transition-all duration-500 ease-in-out">Ethereal Elegance Digital Style Guide</a></h5>
                                <span className="text-slate-400">R250.00</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/3 sm:w-1/2 picture-item p-4 rounded-md">
                        <div className="dfddf">
                            ...
                            <div className="pt-4 px-3">
                                <h5 className="mb-1 font-semibold text-lg"><a href="https://1.envato.market/techwind" target="_blank" rel="noreferrer" className="hover:text-emerald-600 transition-all duration-500 ease-in-out">LuminaLux Statement Earrings Set</a></h5>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                        <div>
                            <div className="p-6 mb-6 border border-gray-100 transition duration-500 group transform hover:-translate-y-2 hover:shadow-2xl rounded-2xl cursor-pointer">
                                <a href="#1" className="absolute opacity-0 top-0 end-0 start-0-0 bottom-0"></a>
                                <div className="relative mb-4 rounded-lg">
                                    <Image
                                                ...
                                                alt="responsive"
                                                ></Image>
                                    <a className="flex justify-center items-center bg-purple-500 bg-opacity-80 z-10 absolute top-0 start-0-0 w-full h-full text-white rounded-lg opacity-0 transition-all duration-300 transform group-hover:scale-105 text-xl group-hover:opacity-100" href="/home" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-1">
                                            <div className="bcfbg">
                                                ...
                                                <p className="text-sm text-gray-500">Published 53 minutes ago</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <h3 className="font-medium text-xl leading-8">
                                    <a href="#2" className="block relative group-hover:text-purple-500 transition-colors duration-200">
                                        Lorem ipsum dolor sit amet, Sed ad minus voluptate?
                                    </a>
                                </h3>
                            </div>
                        </div>
                            ...
                            <div className="p-6 mb-6 border border-gray-100 transition duration-500 group transform hover:-translate-y-2 hover:shadow-2xl rounded-2xl cursor-pointer">
                                ...
                                <div className="flex justify-between items-center w-full pb-4 mb-auto">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-1">
                                            <div className="">
                                                <p className="text-sm font-semibold">Audie predovic</p>
                                                <p className="text-sm text-gray-500">Published 53 minutes ago</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex justify-end">
                                        <div className="text-sm flex items-center text-gray-500">
                                            5 min <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                        </div>
                                    </div>
                                ...
                                <h3 className="font-medium text-xl leading-8">
                                    <a href="#2" className="block relative group-hover:text-purple-500 transition-colors duration-200">
                                        Interactive aggregate inltiatives
                                    </a>
                                </h3>
                            </div>
                        </div>
                            ...
                            <div className="p-6 mb-6 border border-gray-100 transition duration-500 group transform hover:-translate-y-2 hover:shadow-2xl rounded-2xl cursor-pointer">
                                ...
                                <div className="relative mb-4 rounded-lg">
                                    <Image
                                            ...
                                            className="h-52 rounded-lg w-full object-cover transition-transform duration-500 transform group-hover:scale-105"
                                            alt="responsive"
                                            ></Image><a className="flex justify-center items-center bg-purple-500 bg-opacity-80 z-10 absolute top-0 start-0 w-full h-full text-white rounded-lg opacity-0 transition-all duration-300 transform group-hover:scale-105 text-xl group-hover:opacity-100" href="/home" target="_blank" rel="noopener noreferrer">
                                        Read article <svg className="ml-2 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7"></path>
                                        </svg>
                                    </a>
                                ...
                                <div className="flex justify-between items-center w-full pb-4 mb-auto">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-1">
                                            <div className="">
                                                <p className="text-sm font-semibold">Martine moore</p>
                                                <p className="text-sm text-gray-500">Published 53 minutes ago</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex justify-end">
                                        <div className="text-sm flex items-center text-gray-500">
                                            7 min <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                        </div>
                                    </div>
                                ...
                                <h3 className="font-medium text-xl leading-8">
                                    <a href="#2" className="block relative group-hover:text-purple-500 transition-colors duration-200">
                                        Enterprise incentivize web-readiness
                                    </a>
                                </h3>
                            </div>
                        </div>
