            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div className="lg:col-span-7 md:col-span-6">
                    <div className="lg:ml-5">
                        ...
                        <div className="mt-6">
                            <a href="contact-one.html" className="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-2">iconHere Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-4 sticky md:col-span-6">
                    <div className="sticky fixed top-20">
                        ...
                        <ul className="list-none text-center mt-8">
                            <li className="inline"><a href="/" className="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-indigo-600 hover:text-white hover:bg-indigo-600">icon</a></li>
                            <li className="inline"><a href="/" className="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-indigo-600 hover:text-white hover:bg-indigo-600">icon</a></li>
                            <li className="inline"><a href="/" className="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-indigo-600 hover:text-white hover:bg-indigo-600">icon</a></li>
                            <li className="inline"><a href="/" className="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-indigo-600 hover:text-white hover:bg-indigo-600">icon</a></li>
                            <li className="inline"><a href="/" className="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-indigo-600 hover:text-white hover:bg-indigo-600">icon</a></li>
