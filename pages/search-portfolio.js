      ...
      <div className="grid md:grid-cols-4 md:gap-5">
        ...
        <div className="md:col-span-3">
          ...
          <div className="flex justify-center mt-4">
             <h2 className="h2 my-4">South African Jobs, Bursaries, Learnerships</h2>
          </div>
...
export async function getServerSideProps({ query }) {
 ...
 const postDocs = await   Portfolio.find(
    {
      ...queryFilter,
      ...categoryFilter,
      ...ratingFilter,
  ...
  const countPosts = await Portfolio.countDocuments({
    ...queryFilter,
    ...categoryFilter,
    ...ratingFilter,
  });
