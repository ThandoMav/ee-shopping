...
export default function Contact() {
  ...
  const submitHandler = async ({ email, name, career }) => {
    try {
  ...
  return (
    <Layout title="Login">
      ...
      >
        ...
        <div className="mb-4">
          <label htmlFor="password">Career</label>
          <input
            type="password"
            {...register('career', {
              required: 'Please enter career',
              minLength: { value: 6, message: 'career is more than 5 chars' },
            })}
            className="w-full rounded-r rounded-l sm:rounded-l-none border border-gray-400 border-b block pl-4 pr-6 py-2 w-full bg-white text-sm placeholder-gray-400 text-gray-700 focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none"
            id="password"
            autoFocus
        ...
        <div className="mb-4 ">
          <button className="primary-button">Communicate</button>
        </div>
        <div className="mb-4 ">
