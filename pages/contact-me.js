          ...
          <div className="container mt-6 mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2">
                      ...
                      <form method="post" name="myForm" id="myForm" onSubmit={handleSubmit(submitHandler)}>
                          <p id="error-msg"></p>
                          ...
                          <div className="space-y-6">
                              ...
                              <input
                                ...
                                {...register('subject', {
                                  ...
                                  minLength: { value: 6, message: 'subject is more than 5 chars' },
                                })}
                                className="border border-gray-300 text-gray-900 text-sm focus:ring-0 focus:border-blue-500 block w-full p-3"
                                name="subject"
                              ...
                              <textarea
                              className="border border-gray-300 text-gray-900 text-sm focus:ring-0 focus:border-blue-500 block w-full p-3" placeholder="Your Message" name="comments" id="comments" rows="3" spellcheck="false"></textarea>
                              <input
                                type="text"
                                {...register('message', {
                                  required: 'Please your enter message',
                                  minLength: { value: 6, message: 'message is more than 5 chars' },
                                })}
                                className="border border-gray-300 text-gray-900 text-sm focus:ring-0 focus:border-blue-500 block w-full p-3"
                                name="message"
                              ...
                              <div className="text-right">
                                  ...
                                  <button className="py-4 px-6 rounded-full uppercase cursor-pointer text-sm transition-all bg-slate-800 hover:bg-black text-white">Communicate</button>
                              </div>
                          </div>
                      </form>
                  </div>
